...
...Am 30. Januar 2020 findet im Bahnhof Olten ein Workshop zur
OpenSource Administrationsplattform OpenOlitor für
RVL-Initiativen/SOLAWI statt..
Der Unkostenbeitrag beträgt 20 Franken,


### finanzierung
[Finanzierung – OpenOlitor](http://openolitor.org/finanzierung/)
...
> 
> -   gemeinsame Basisfinanzierung für [Basisaufgaben](http://openolitor.org/openolitor-nutzen/verein-openolitor/) des Vereins OpenOlitor
...
### solidbase - Financial sustainability for Solidarity based Food Systems

SolidBase ist ein Bildungsprojekt, in dessen Rahmen 4 Module erstellt
wurde, die dazu beitragen sollen die finanzielle Stabilität von SFS
(Solidarity Based Food Systems) zu verbessern. Die Module umfassen
“Management von SFS”, “Finanz und Unternehmensplanung von SFS”,
“Digitale Fähigkeiten” und “Möglichkeiten für die Einbindung der
Mitglieder”.


[solidbase](https://app.solidbase.info/)

> The SolidBase application is an **educational tool** for budget
> planning and presentation. It was developed to help build accounting
> capacities for coordinators of initiatives active in Solidarity based
> Food Systems (SFS), but is usable for all sorts of solidarity and
> social economy enterprises..



urgenci.be - European CSA Declaration
----

> As firmly stated in the [European CSA
> Declaration](http://urgenci.net/wp-content/uploads/2016/09/European-CSA-Declaration_final-1.pdf),
> citizens and farmers engaged in CSA across Europe aim, among others
> objectives, “_to enable sharing of knowledge and skills between CSAs
> in different countries, to empower and educate people to act for and
> develop the movement and to show the benefits of CSA for the whole of
> society._”.


arc2020.eu  Agricultural and Rural Convention ??? france
----
[About ARC2020 | Agricultural and Rural Convention](https://www.arc2020.eu/about-arc2020/)

> **Who funds ARC2020?**
> 
> The ARC2020 is a common initiative of a European think tank working on
> agriculture policies called [Groupe de
> Bruges](http://www.groupedebruges.eu/index_fr.htm), a European network
> of local projects in sustainable rural development called [Forum
> Synergies](http://www.forum-synergies.eu/), and the European School
> for Journalists called [IHECS](http://www.ihecs.be/). The ARC is
> supported by the Foundation Charles Leopold Mayer [Fondation pour le
> progress de l’homme](http://www.fph.ch/), the [OAK
> Foundation](http://www.oakfnd.org/) and the [MAVA
> Foundation](http://www.mava-foundation.org/)..



(https://www.arc2020.eu/our-contributors/)

[We're Hiring! | ARC2020 CAP Strategic Policy
Animator](https://www.arc2020.eu/were-hiring-arc2020-cap-strategic-policy-animator/)

ARC2020 – The Agricultural and Rural Convention has worked on the
European Union’s Common Agricultural Policy (CAP) since 2010. Run by a
small team and guided by an international group of board members, ARC
runs the leading independent and NGO-oriented website on this issue. ARC
carries out research, publishes regular content and organises debates
and events on key CAP-related issues. ARC is now hiring a full time
position to work on two related areas: developing content on the CAP
Strategic Plan Regulations; organising NGO and institutional networking
around the national strategic plans implementing the next CAP..


ARC2020 is a multi-stakeholder platform that has involved over 150 civil
society networks and organisations (from 22 EU Member States) all
working on issues affected by the EU’s Common Agricultural Policy
(CAP)..



[Agricultural and Rural Convention 2020 - Wikipedia](https://en.wikipedia.org/wiki/Agricultural_and_Rural_Convention_2020)

> **Agricultural and Rural Convention 2020** (**ARC2020**) describes
> itself as "a multi-stakeholder platform of over 150 civil society
> networks and organisations within 22 [EU Member
> States](https://en.wikipedia.org/wiki/EU_Member_States "EU Member
> States") all pushing for a reform of the EU’s [Common Agricultural
> Policy](https://en.wikipedia.org/wiki/Common_Agricultural_Policy
> "Common Agricultural Policy")
> (CAP)".[\[1\]](https://en.wikipedia.org/wiki/Agricultural_and_Rural_Convention_2020#cite_note-What_is_ARC-1)
> It has carried out several campaigns to raise awareness among citizens
> and the political world on the current situation of European
> agriculture, such as the [Good Food
> March](https://en.wikipedia.org/wiki/Good_Food_March "Good Food
> March").[\[2\]](https://en.wikipedia.org/wiki/Agricultural_and_Rural_Convention_2020#cite_note-2)[\[3\]](https://en.wikipedia.org/wiki/Agricultural_and_Rural_Convention_2020#cite_note-3)[\[4\]](https://en.wikipedia.org/wiki/Agricultural_and_Rural_Convention_2020#cite_note-4)[\[5\]](https://en.wikipedia.org/wiki/Agricultural_and_Rural_Convention_2020#cite_note-5).



[Groupe de Bruges - Wikipedia](https://en.wikipedia.org/wiki/Groupe_de_Bruges)

> The **Groupe de Bruges** is a European
> [think-tank](https://en.wikipedia.org/wiki/Think-tank "Think-tank")
> specializing in
> [agriculture](https://en.wikipedia.org/wiki/Agriculture "Agriculture")
> and [rural
> development](https://en.wikipedia.org/wiki/Rural_development "Rural
> development"). In November 2009 one of its members, Romanian [Dacian
> Cioloş](https://en.wikipedia.org/wiki/Dacian_Ciolo%C5%9F "Dacian
> Cioloş"), was nominated [European
> Commissioner](https://en.wikipedia.org/wiki/European_Commission
> "European Commission") for Agriculture by [European Commission
> President](https://en.wikipedia.org/wiki/Commission_President
> "Commission President") [José Manuel
> Barroso](https://en.wikipedia.org/wiki/Jos%C3%A9_Manuel_Barroso "José
> Manuel Barroso")..

The Groupe de Bruges was created in 1995 by Edgard Pisani and Bertrand
Hervieu as a Europe-wide successor to the French Groupe de Seillac
(1992-5). The latter had been formed in the context of the debate on
